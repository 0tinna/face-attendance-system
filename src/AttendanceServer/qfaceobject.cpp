...
{
    //初始化
    seeta::ModelSetting  FDmode("C:/env/SeetaFace/bin/model/fd_2_00.dat",seeta::ModelSetting::CPU,0);
    seeta::ModelSetting  PDmode("C:/env/SeetaFace/bin/model/pd_2_00_pts5.dat",seeta::ModelSetting::CPU,0);
    seeta::ModelSetting  FRmode("C:/env/SeetaFace/bin/model/fr_2_10.dat",seeta::ModelSetting::CPU,0);
